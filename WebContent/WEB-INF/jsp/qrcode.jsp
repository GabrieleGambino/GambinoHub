...
<div id="modalqr" class="modal">
	<form class="modal-content">
		<div class="container">
			<span class="close"><a href="<%=request.getContextPath()%>/HubVaccinale/home.jsp">×</a></span>
    		...
    		<div class="clearfix">
				<a href="<%=request.getContextPath()%>/HubVaccinale/home.jsp"><button type="button" class="cancelbtn">Chiudi</button></a>
			</div>
		</div>
	</form>
</div>