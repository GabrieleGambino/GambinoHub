CREATE DATABASE  IF NOT EXISTS `gambinodb` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gambinodb`;
-- MySQL dump 10.13  Distrib 8.0.27, for Win64 (x86_64)
--
-- Host: localhost    Database: gambinodb
-- ------------------------------------------------------
...
INSERT INTO `account` VALUES ('luigirossi@medico.it','5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8',1),('mariorossi@medico.it','5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8',0);
...
INSERT INTO `prenotazione` VALUES ('02dc381033f3666c22cd9e6f564aa03ecaece693','2021-11-08','14:29:00','Operatore Scolastico','Personale scolastico','Nessuna scelta','VNCGCR55A01H501R','Giancarlo','Vincenti','Roma','Via roma','3456712342',1),('1fa477336005836ee9d7afe26b194d088ab88ddb','2021-11-18','20:26:00','Forze di Polizia','Comparto Forze dell\'Ordine','Nessuna scelta','CTLLDA58A01A089U','Aldo','Cataldo','Agrigento','via agrigento','3313475689',1),('380622e08b36b19eda40c973606ae343fa8f340e','2021-11-19','11:24:00','Soggetto vulnerabile per Patologia','Malattie respiratorie','INSUFFICIENZA RESPIRATORIA CRONICA','VNCMRA80A01H501K','Mario','Vincenti','Roma','Via roma','3451676890',0),('3c1191d2210bd7980e06b559c4a0a6898d9caeb3','2021-12-09','17:17:00','Età > 60','Età 60-79 anni','Nessuna scelta','Gabriele','Gabriele','Gambino','Gambino','Viale XXVII Maggio','3313436171',0),('58156a799a7beee8ce33a26e4358d4513d8755ba','2021-11-20','18:10:00','Età < 60','16-59 anni con patologie non gravi','Nessuna scelta','GMBGLR96H273KH08','Gabriele','Gambino','Palermo','Viale XXVII Maggio, 19','3313436171',0),('a1cea749b99047429e9aa2e860ca6cc1572c06a7','2021-11-20','20:39:00','Età > 60','Over 80','Nessuna scelta','LVINNA62A01G273Q','Anna','Lieve','Palermo','Via Palermo','3245678901',1),('bf1c3591e638378b2a507155ff9c6244011bcef0','2021-11-10','20:25:00','Soggetto vulnerabile per Patologia','Malattia epatica','CIRROSI EPATICA ALCOOLICA','FRNGTN80A01C351N','Gastani','Frinzi','Catania','Via catania','3201234567',0),('d222bd5cbe3bbfb4e82a066d51431046f7f0b5fb','2021-11-03','17:44:00','Età < 60','16-59 anni con patologie non gravi','Nessuna scelta','GMBVLR96H08273K0','Valerio','Gambino','Palermo','Viale XXVII Maggio','3313436172',0);
...
CREATE TABLE `vaccinazione` (
  `id_vacc` int NOT NULL AUTO_INCREMENT,
...
INSERT INTO `vaccinazione` VALUES (1,'2021-11-20','18:45:00','Pfizer','Vaccino confermato','a1cea749b99047429e9aa2e860ca6cc1572c06a7','mariorossi@medico.it'),(2,'2021-11-18','18:51:00','Astrazeneca','tutto ok','1fa477336005836ee9d7afe26b194d088ab88ddb','mariorossi@medico.it'),(3,'2021-11-08','18:53:00','Moderna','svenuto post inoculazione','02dc381033f3666c22cd9e6f564aa03ecaece693','mariorossi@medico.it');
...
-- Dump completed on 2021-11-07 18:08:51
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-11-02 21:30:31',NULL),('diagnostics.include_raw','OFF','2021-11-02 21:30:31',NULL),('ps_thread_trx_info.max_length','65535','2021-11-02 21:30:31',NULL),('statement_performance_analyzer.limit','100','2021-11-02 21:30:31',NULL),('statement_performance_analyzer.view',NULL,'2021-11-02 21:30:31',NULL),('statement_truncate_len','64','2021-11-02 21:30:31',NULL);
...
-- Dump completed on 2021-11-07 18:08:52
