package hubvaccinale.controller.sql;
...
import hubvaccinale.conversion.JDBCUtil;
...
public class SQLhelp {
	...
	public static void open() {
		try {
			...
			DataSource ds = (DataSource) ctx.lookup("java:comp/env/jdbc/gambinodb");//nome mio database
